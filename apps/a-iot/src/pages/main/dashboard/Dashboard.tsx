...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      {/* Row 2: 지도(3/5) + 오른쪽 패널(2/5) — 항상 표시, 높이 동기화 */}
      <div className="grid grid-cols-5 gap-4 mb-4 auto-rows-fr">
        {/* 지도 카드 — 꽉 차게 */}
        <Card className="col-span-3 overflow-hidden relative">
          {activeTab === 'parks' && (
            <div className="absolute top-3 left-3 z-10">
              <Select value={selectedSiteId || ''} onValueChange={setSelectedSiteId}>
                <SelectTrigger className="w-48 bg-white/90 backdrop-blur-sm shadow-md">
        ...
        {/* 오른쪽 패널: 전체보기=이벤트 현황, 공원별=장치 현황 */}
        {activeTab === 'overview' ? (
          <Card className="col-span-2">
            <CardHeader className="pb-2">
              <CardTitle className="text-lg font-bold">이벤트 현황</CardTitle>
            </CardHeader>
            <CardContent>
              {!isEventStoreInitialized ? (
                <div className="flex items-center justify-center gap-2 text-gray-500 h-full">
                  <Spinner size="sm" />
                  <span>이벤트 로딩 중...</span>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center justify-between p-3 rounded-lg bg-red-50 border-l-4 border-red-500">
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg bg-amber-50 border-l-4 border-amber-500">
                      <div className="flex items-center gap-2">
          ...
          <Card className="col-span-2">
            ...
            <CardContent>
              <div className="bg-zinc-200/50 rounded-lg p-4 mb-3">
      ...
      {/* Row 3: 이벤트 테이블(3/5) + 배터리 알람(2/5) — 항상 표시 */}
      <div className="grid grid-cols-5 gap-4">
        <Card className="col-span-3">
          <CardHeader className='p-5 pb-3'>
            <CardTitle className="text-lg font-bold">이벤트 리스트</CardTitle>
          </CardHeader>
          <CardContent className='p-5 pt-0'>
            {(() => {
              const displayEvents = activeTab === 'parks' && selectedSiteId ? filteredEvents : allFilteredEvents
        ...
        <Card className="col-span-2">
          <CardHeader className="p-5 pb-3">
            <CardTitle className="text-lg font-bold">배터리 알람</CardTitle>
          </CardHeader>
          <CardContent className="p-5 pt-0">
            {(() => {
